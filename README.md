...
| 主界面 | 会话侧边栏 |
| --- | --- |
| <img src="docs/screenshots/mobile-chat-empty.png" alt="CodeRoam 主界面" width="260"> | <img src="docs/screenshots/mobile-drawer.png" alt="CodeRoam 会话侧边栏" width="260"> |
| 手机端主界面，用来查看 Codex 输出、发送 prompt、切换模型和处理任务状态。 | 会话与工作区入口，便于在手机上切换项目、恢复历史会话。 |

| 扫码配对 | 手动配对 |
| --- | --- |
| <img src="docs/screenshots/pairing-scan.png" alt="CodeRoam 扫码配对" width="260"> | <img src="docs/screenshots/pairing-json.png" alt="CodeRoam 手动配对" width="260"> |
| 扫描 Linux bridge 生成的二维码，快速建立手机与主机的加密连接。 | 无法扫码时，可以粘贴 Pairing JSON 完成同样的配对流程。 |
